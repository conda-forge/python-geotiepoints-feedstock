...
validate_recipe_outputs "python-geotiepoints-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="python-geotiepoints-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi